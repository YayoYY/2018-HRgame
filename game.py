...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        # 1. 初始化主体
        self.env = Environment(16, 4, 0.5)  # 环境
...
"background-color: rgb(224, 224, 224);")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_5.setText(_translate("Form", "首先，感谢您对本研究的大力支持！本实验旨在收集您与机器人算法交互过程中的行为数据，以此验证人机协作仿真平台设计的合理性与有效性。"))
        self.label_6.setText(_translate("Form", "您（左图中的H）要与机器人（左图中的R）共同完成一个协作救援任务，任务①和②的位置固定在左上角和右下角。每次救援活动开始，您与机器人的位置随机设置，但不与两个任务位置重合。当且仅当您与机器人的位置共同达到某一任务处时，本轮救援才算结束，下一轮救援活动开始（您与机器人位置随机初始化）。您与机器人按照次序移动，每次一步，共有100步。屏幕最下方展示了您与机器人累积完成的任务总数，以及机器人到达任务场地的总次数。"))
        self.label_7.setText(_translate("Form", "现在已经为您初始化好了第一轮协作救援的位置，点击右侧操作按钮即可开始实验。再次感谢您的支持！"))
        self.label_8.setText(_translate("Form", "H"))
        self.label_9.setText(_translate("Form", "R"))
        self.label_10.setText(_translate("Form", "累积完成任务总数："))
        self.label_11.setText(_translate("Form", "机器人到达任务场地数："))
